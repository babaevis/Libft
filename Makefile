...
#    Updated: 2020/11/05 20:22:08 by kroyce           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
    ...
    ft_isprint.c ft_toupper.c ft_tolower.c ft_isblank.c ft_putnbr.c\
    ft_strmapi.c ft_substr.c ft_split.c ft_calloc.c ft_putstr.c\
    ft_strjoin.c ft_strtrim.c ft_itoa.c ft_putchar.c ft_strcmp.c\
